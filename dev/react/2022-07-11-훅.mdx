...
Hook은 React 16.8부터 추가되었다. Hook을 사용하면 기존 클래스형 컴포넌트에서만 사용가능하던 상태관리, 라이프사이클 메소드 등의 여러 기능을 사용할 수 있다.
...
<!-- 클래스형 컴포넌트에 비해 `코드가 간결해지고 Custom Hook을 사용해 로직 재활용이 가능`해진다.
클래스형 컴포넌트에서 로직 재활용을 위해선 HOC를 사용했다. -->
